...
- Runtime-package integration (`kont`, `cove`, `takt`, `sess`): read [uring/agents/runtime/kont.md](../runtime/kont.md), [uring/agents/runtime/cove.md](../runtime/cove.md), [uring/agents/runtime/takt.md](../runtime/takt.md), [uring/agents/runtime/sess.md](../runtime/sess.md), [uring/agents/formalization/handler.md](../formalization/handler.md), and [uring/agents/formalization/sessions.md](../formalization/sessions.md); check the lifts in [uring/agents/lift/protocols-runtime.md](../lift/protocols-runtime.md) and [uring/agents/lift/policy-separation.md](../lift/policy-separation.md).
...
For a broad guide edit or broad caller-side work, read every indexed topic file and check every lift record.
